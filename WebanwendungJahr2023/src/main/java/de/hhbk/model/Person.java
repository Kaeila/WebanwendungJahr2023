...
public abstract class Person extends ModelTemplate
{
  ...
  //-------------------------------------------------------------------------     
    ...
    public PersonAnrede getAnrede() { return anrede; }

    public void setAnrede(PersonAnrede anrede) { this.anrede = anrede; }    
    
    public String getGeschlecht() { return getAnrede().getGeschlecht(); }
    
    public boolean isWeiblich() { return (anrede == PersonAnrede.MRS); }
 
    public boolean isMaennlich() { return (anrede == PersonAnrede.MR); }
