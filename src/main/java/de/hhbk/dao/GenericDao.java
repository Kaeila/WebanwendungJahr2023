...
public class GenericDao<T extends IdInterface> implements Serializable
{
  ...
  //  Constructor(s)
  //------------------------------------------------------------------------- 
    public GenericDao(Class clazz) { this.clazz = clazz; }
  ...
  //------------------------------------------------------------------------- 
    protected Object executeQuery(Function<Session, Object> code) throws Exception
    {
        ...
        finally { try { session.close(); } catch (Exception e) { } }
        return r; 
    }
  ...
  //-------------------------------------------------------------------------   
    ...
    { 
        executeQuery( (session) -> { session.evict(o); return null; });
    }
  ...
  //-------------------------------------------------------------------------   
    ...
    { 
        executeQuery( (session) -> { session.clear(); return null; });
    }
